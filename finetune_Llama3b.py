...
# input paths
base_model = 'meta-llama/Llama-3.2-3B'  # or 'meta-llama/Llama-3.2-3B-Instruct' if you prefer
re_arc_path = os.path.join('input', 're_arc')  # https://github.com/michaelhodel/re-arc

# output paths
save_model_path = os.path.join('pretrained_models', "Llama-3.2-3B-ARChitects-ReArc369-bnb-4bit")
...
for action in ['train', 'merge']:
    ...
    if action == 'train':
        # load training data
        train_dataset = ArcDataset.load_from_rearc(re_arc_path, n=368, sizes=[6], seed=42, remove_easiest=0.5)
